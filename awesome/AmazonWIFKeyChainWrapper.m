...
@implementation AmazonWIFKeyChainWrapper
...
{
    [AmazonWIFKeyChainWrapper storeValueInKeyChain:theUsername forKey:kKeychainUsernameIdentifier];
}

+(NSString *)username
{
    return [AmazonWIFKeyChainWrapper getValueFromKeyChain:kKeychainUsernameIdentifier];
}
...
{
    OSStatus keychainError = SecItemDelete((CFDictionaryRef)[AmazonWIFKeyChainWrapper createKeychainDictionaryForKey : kKeychainUsernameIdentifier]);
